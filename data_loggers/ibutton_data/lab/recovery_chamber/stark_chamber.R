...
ibutton.data.temp <- read.ibutton.folder("ibutton_data/lab/recovery_chamber/temp")
ibutton.data.RH <- read.ibutton.folder("ibutton_data/lab/recovery_chamber/RH")
...
with(subset(ibutton.dataframe.temp,ibutton=="stark_chamber_temp_061019"),plot(Date.Time,Value,type="n"))
...
with(subset(ibutton.dataframe.RH,ibutton=="stark_chamber_rh_061019"),plot(Date.Time,Value,type="n"))
